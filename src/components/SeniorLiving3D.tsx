...
export default function SeniorLiving3D({ scale = 1.3 }: SeniorLiving3DProps) {
    ...
    useEffect(() => {
        ...
        const timeoutId = setTimeout(() => {
            ...
            signGroup.scale.set(0.68, 0.68, 0.68); // Increased from 0.55
            houseGroup.add(signGroup);

            // 1. Emissive Backing Plate
            const lightPlateGeom = new THREE.PlaneGeometry(4.6, 1.2); // Balanced size
            ...
            const glassGeometry = new RoundedBoxGeometry(4.7, 1.3, 0.26, 8, 0.05); // Balanced size
            ...
            const bulbGeo = new THREE.CylinderGeometry(0.04, 0.04, 4.2, 12); // Slightly bigger tubes
            ...
            const createSignTextTexture = (text: string) => {
                ...
                if (context) {
                    ...
                    context.font = 'bold 88px "Inter", sans-serif'; 
            ...
            const signTextPlane = new THREE.Mesh(new THREE.PlaneGeometry(4.2, 1.1), signTextMaterial); // Balanced width
