        ...
        <div className="flex flex-col h-full justify-center relative overflow-hidden">
            <AnimatePresence mode="wait">
                ...
                {step === "recommendation" && (
                    ...
                    >
                        <div className="flex-1 p-6 flex flex-col justify-center space-y-4 min-h-0">
                            <div className="text-center px-4">
                                <h3 className="text-[#1B1326]/40 text-[7px] sm:text-[8px] uppercase tracking-widest font-black leading-tight">Well done. Need support today?</h3>
                            </div>

                            <div className="bg-white p-4 sm:p-5 rounded-[20px] shadow-sm border border-black/5 relative overflow-hidden max-w-[340px] mx-auto w-full">
                                <div className="absolute top-0 right-0 w-16 h-16 bg-[#5B2A86]/5 rounded-full -mr-8 -mt-8 blur-xl" />

                                <div className="space-y-1.5 sm:space-y-2">
                                    <div className="flex items-center gap-1.5 text-[#D6B36A]">
                                        <ArrowRight className="w-3 h-3" />
                                        <span className="text-[7px] uppercase tracking-[0.2em] font-black">Recommendation</span>
                                    </div>
                                    <h3 className="text-base sm:text-xl font-light text-[#5B2A86]" style={{ fontFamily: "var(--font-playfair), serif" }}>
                                        {getRecommendation().title}
                                    </h3>
                                    <p className="text-[10px] sm:text-xs text-[#1B1326]/70 font-light leading-relaxed">
                        ...
                        <button
                            onClick={onReset}
                            className="bg-white border-t border-black/5 p-3 text-center text-[8px] uppercase tracking-[0.2em] text-[#1B1326]/30 font-black hover:text-[#5B2A86] transition-colors"
                        >
