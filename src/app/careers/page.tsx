...
export default function CareersPage() {
    return (
        <main className="min-h-screen bg-[#0F1115] text-[#F2F2F2] selection:bg-[#B9A3D3]/30">

            {/* Hero Section */}
            <section className="relative pt-32 pb-20 overflow-hidden" style={{ background: 'linear-gradient(135deg, #0F1115 0%, #1B1326 55%, #24163A 100%)' }}>
                ...
                <div className="container mx-auto px-6 relative z-10">
                    ...
                    >
                        ...
                        <p className="Text-20 text-white/60 max-w-2xl font-light leading-relaxed">
                    ...
                    >
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-white/50">Please note that we are not currently recruiting from outside of the UK.</p>
                            </div>
                        </div>
            ...
            <section className="py-24 bg-[#0F1115]">
                <div className="container mx-auto px-6">
                    <div className="mb-16">
                        ...
                        <div className="w-20 h-1 bg-gradient-to-right from-[#B9A3D3] to-transparent" />
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        {OFFERS.map((offer, idx) => (
                            <motion.div
                                ...
                                className="p-8 group bg-white/5 border border-white/5 hover:border-[#B9A3D3]/30 rounded-2xl transition-all"
                            >
                                <div className="text-[#B9A3D3] mb-6 transform group-hover:scale-110 transition-transform origin-left">
                                    {offer.icon}
                                </div>
                                <h4 className="text-white font-semibold text-lg mb-3 tracking-tight">{offer.title}</h4>
                                <p className="text-white/40 text-sm leading-relaxed font-light">{offer.description}</p>
                            </motion.div>
                        ))}
                    </div>
                </div>
                ...
                <div className="container mx-auto px-6">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            ...
                            <div className="space-y-6 text-white/60 font-light leading-relaxed Text-18">
                                <p>
                        ...
                        {ROLES.map((role, idx) => (
                            ...
                            >
                                ...
                                <div className="hidden md:flex items-center gap-12">
                                    <span className="text-[10px] font-bold tracking-[0.2em] uppercase text-black/40">Full Time / Part Time</span>
