    ...
    return (
        <main className="min-h-screen pt-32 pb-24 bg-[#faf9f6]">
            ...
            <section className="container mx-auto px-6 md:px-12 mb-24 max-w-4xl text-center">
                ...
                >
                    Driven by <span className="italic text-[#c5a265]">compassion.</span>
                </motion.h1>
            </section>
                ...
                <div className="mt-32 grid md:grid-cols-3 gap-12">
                    {[1, 2, 3].map((item) => (
                        <div key={item} className="space-y-4 text-left">
                            <div className="aspect-[3/4] bg-[#ebe9e1] rounded-sm w-full" />
                            <h3 className="Heading-Serif text-xl text-[#1c1c1c]">Clinical Lead</h3>
                            <p className="text-[#8e948c] text-sm tracking-widest uppercase">Senior Team</p>
                        </div>
                    ))}
                </div>
            </section>
